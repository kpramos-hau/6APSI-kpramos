    ...
    <div >
        <div className='nav-bar'>
            <div className='nav-bar-items'>
                ...
                <div className='nav-bar-login'>
                    <button className='button-nav' onClick={handleLogin}>Login</button>
                </div>
        </div>
        <div className='main-content'>
            <div className='left-hero-text'>
                ...
                <button className='main-content-button' onClick={handleLogin} >Register</button>  {/* this button leads to the login page */}
            </div>
